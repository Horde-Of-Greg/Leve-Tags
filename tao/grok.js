...
if (situation !== 1 && situation !== -2) {
  try {
    response = http.request({
      url: "http://37.27.220.107:3002/leveret/grok/nomicord",
      method: "POST",
      responseType: "json",
      data: {
        userId: msg.authorId,
...
const grokPfp =
  "https://cdn.discordapp.com/attachments/927073124086849577/1404258458177372301/iu.png?ex=689a891a&is=6899379a&hm=aea64f5f451dc9e464aa494ef683ebf2b3d952e775c02771ecdfb9d4512e033d&";
let footerText = "";
